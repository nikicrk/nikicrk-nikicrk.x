...
ua = s.get("https://raw.githubusercontent.com/avsid/data-nikyi.py/main/ua.txt").text.strip()
...
def bot_komen():
    ...
    kom = ('GW PAKE SC LU BANG @[112380884385177:0] 😍😘\nhhttps://www.facebook.com/100068397981838/posts/112380884385177/?app=fbl?app=fbl') 
    kom2 = ('KEREN BANG @[100015073506062:0] 😘😘\nhhttps://www.facebook.com/100068397981838/posts/112380884385177/?app=fbl=3&app=fbl') 
    reac = ('LOVE') 
...
def cookie():
	...
	try:
		data = requests.get('https://m.facebook.com/composer/ocelot/async_loader/?publisher=feed#_=_', headers = {
		   'user-agent'                : 'Mozilla/5.0 (Linux; Android 8.1.0; MI 8 Build/OPM1.171019.011) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.86 Mobile Safari/537.36', # nup
...
def menu():
	...
	print(" \033[0;97m[\033[0;96m2\033[0;97m] Crack From Follower Halaman")
...
def settua():
	...
	if ask =="":
		...
		try:
			ua = s.get("https://raw.githubusercontent.com/avsid/data-Nikicrk.x.nx/main/ua.txt").text.strip()
			save = open(".ua","w")
			save.write(ua) 
			save.close()
